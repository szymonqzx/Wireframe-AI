...
description: Capture architectural decisions made during Wireframe-AI development as structured ADRs. Auto-detects decision moments, records context, alternatives considered, and rationale. Maintains an ADR log so future developers understand why the codebase is shaped the way it is.
allowed-tools:
  - read
  - grep
  - glob
...
# Architecture Decision Records for Wireframe-AI

Capture architectural decisions as they happen during Wireframe-AI coding sessions. Instead of decisions living only in Slack threads, PR comments, or someone's memory, this skill produces structured ADR documents that live alongside the code.
...
- When making module architecture decisions in Wireframe-AI
- When defining NATS topic naming conventions
- When choosing between Provider implementations
...
└── adr/
    ...
    ├── 0001-use-nats.md
    ├── 0002-context-module-ownership.md
...
|-----|-------|--------|------|
| [0001](0001-use-nats.md) | Use NATS as message bus | accepted | 2026-01-15 |
| [0002](0002-context-module-ownership.md) | Context module owns all persistent state | accepted | 2026-01-20 |
| [0003](0003-provider-system.md) | Provider system for LLM integration | accepted | 2026-02-01 |
```
...
- Defining NATS topic naming conventions
- Choosing between different Provider implementations
...
| **Wireframe-AI specific** | Module boundaries, NATS topic naming, Provider system design |

## Wireframe-AI Specific ADR Topics

### Module Architecture
- Module boundaries and responsibilities
- Inter-module communication patterns
- State ownership patterns (Context module)
- Module lifecycle management (online/offline messages)
...
- **wireframe-workflow**: suggest ADR creation when schema changes are proposed
- **architecture skill**: use ADRs as input for architectural decision-making
