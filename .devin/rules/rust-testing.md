...
paths:
  - "**/*.rs"
---
# Rust Testing for Wireframe-AI

Wireframe-AI specific testing guidelines for modules, NATS messaging, and provider system.
...
├── module_test.rs           # Module integration tests
├── nats_test.rs             # NATS integration tests
...
- `publishes_module_online_on_startup()`
- `handles_nats_connection_failure()`
...
cargo test --test module_test    # Specific integration test (tests/module_test.rs)
cargo test --doc                 # Doc tests only
```

## References

See `rust-testing-wireframe.md` for Wireframe-AI specific testing patterns including NATS, Provider system, and Schema testing.
