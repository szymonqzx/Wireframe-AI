...
paths:
  - "**/*.rs"
---
# Rust Patterns for Wireframe-AI

Wireframe-AI specific Rust patterns for modules, NATS messaging, and schema handling.
...
See `rust-patterns-wireframe.md` for Wireframe-AI specific patterns including NATS messaging, Provider system, and Context state ownership.
